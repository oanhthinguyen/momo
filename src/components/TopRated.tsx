...
export default function TopRated() {
  ...
  return (
    <section className="categories-section" style={{ position: 'relative', backgroundColor: 'var(--background)', paddingTop: '64px', paddingBottom: '64px', borderBottom: '1px solid #e2e8f0' }}>
